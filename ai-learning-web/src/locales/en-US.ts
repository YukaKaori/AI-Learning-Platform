...
const enUS: typeof zhCN = {
  ...
  flashcards: {
    ...
    dueBadge: '{n} due for review',
    newBadge: '{n} new cards',
    review: {
      start: 'Start review',
      reviewAll: 'Review due',
      title: 'Review',
      exit: 'Exit',
      loading: 'Preparing your review queue…',
      errorTitle: 'Could not load the queue',
      errorBody: 'Something went wrong. Try again in a moment.',
      retry: 'Retry',
      emptyTitle: 'All caught up',
      emptyBody: 'Nothing is due for review right now.',
      reveal: 'Show answer',
      newFlag: 'New',
      progress: '{done} / {total}',
      gradeError: 'That grade did not save — try again.',
      doneTitle: 'Session complete',
      doneReviewed: 'Reviewed {n} cards',
      remaining: '{due} due · {new} new still available today',
      finish: 'Done',
      grades: {
        again: 'Again',
        hard: 'Hard',
  ...
  landing: {
    ...
    product: {
      ...
      hero: {
        ...
        wsUser: "Explain gradient descent like I'm building it",
        wsAi: 'Think of it as walking downhill in fog — each step simply follows the slope under your feet.',
        wsChip1: 'Show the math',
        wsChip2: 'Give me code',
        wsCtx: 'This week',
        wsCtx1: 'Linear models',
        wsCtx2: 'Loss functions',
        wsCtx3: 'Gradient descent',
      },
      slides: {
        tutor: {
          title: 'AI Tutor',
          ...
          q: 'Why does quicksort degrade to O(n²)?',
          a: 'When every pivot lands on an extreme value, each pass shrinks the range by only one element — the recursion tree stretches into a chain.',
          chip1: 'Show an example',
          chip2: 'How do I avoid it?',
        ...
        notes: {
          ...
          doc: 'Attention in Transformers',
          body: 'Every token scores its relevance to all the others, then blends their meanings by weight.',
          summaryLabel: 'AI summary',
          summary: 'Attention is a weighted lookup across the whole sequence.',
          chip: 'AI polish',
          link1: 'Self-attention',
          link2: 'Softmax',
          link3: 'Embeddings',
        },
        flashcards: {
        ...
        engine: {
          ...
          steps: 'Reasoning',
          s1: 'Understand the question',
          s2: 'Retrieve your notes',
          s3: 'Reason step by step',
          s4: 'Compose the answer',
          out: 'Comparing your last quiz with today’s notes, the next concept worth reviewing is',
        },
        trust: {
          title: 'Built on principles',
          line: 'No growth hacks, no dark patterns — a learning tool we would use ourselves.',
          t1: 'Learners first',
          d1: 'Every feature exists to deepen understanding, not to hold attention.',
          t2: 'AI-native',
          d2: 'AI is woven through the workspace, not bolted on as a chatbot.',
          t3: 'Private by default',
          d3: 'Your notes and your progress belong to you alone.',
          t4: 'Always evolving',
          d4: 'The platform sharpens with every release, openly, on a public roadmap.',
          m1v: '5',
          m1l: 'Core learning modules',
          m2v: '2',
          m2l: 'Languages, one workspace',
          m3v: '100%',
          m3l: 'Streaming AI responses',
          m4v: '0',
          m4l: 'Ads or trackers',
        },
        roadmap: {
        ...
        cta: {
          ...
          line: 'Sign in and let AI walk the path with you.',
          action: 'Start learning',
        },
      },
    },
